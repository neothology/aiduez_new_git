# AIDUez3.0 <span style="font-size:1.3rem; font-weight:lighter">(Last Updated: 4/28/22 - 00:42AM)</span>
...
```console
source /etc/bash.bashrc && voila /aihub/workspace/AIDUez.ipynb --port 8888 --no-browser --enable_nbextensions True 
```
<br>